...
class managermealController extends Controller
{
    ...
    {
        $cate=$cate->all();
        return view('manager.meal.add',compact('cate'));
    }
  ...
  if($request->has('type')){
     ...
     return redirect('/adminpanel2/meals')->withSuccessMessage('Meals added successfully');
      ...
      {  
          ...
          return view('manager.meal.edit', ['meal' => $meal]);
      }
