...
{{$meal->name}} 
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel/meals/'.$meal->id.'/edit')}}"> Edit Meals </a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            {!! Form::model($meal, ['method' => 'patch','url'=>['/adminpanel/meals',$meal->id],'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
