...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel/meals')}}">Meals</a></li>
              ...
              <table id="example2" class="table table-bordered table-hover" >
                ...
                <tr>
                 ...
                 <td> <img src={{asset('/storage/image/'.$mealinfo->image)}} class=" img-thumbnail imageRest"  >
                  ...
                  <td>
                  <a href="{{url('/adminpanel/meals/'.$mealinfo->id.'/edit')}}" class="btn btn-info">edit</a>
                  
                  <a href="{{url('/adminpanel/meals/'.$mealinfo->id.'/delete')}}" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
                @endforeach
                </tbody>
