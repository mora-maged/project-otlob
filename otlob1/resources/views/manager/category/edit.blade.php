...
{{$cate->name}} 
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel2/categories/'.$cate->id.'/edit')}}"> Edit category </a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            {!! Form::model($cate, ['method' => 'patch','url'=>['/adminpanel2/categories',$cate->id],'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
