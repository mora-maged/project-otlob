...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel2/categories')}}">Categories</a></li>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                  <a href="{{url('/adminpanel2/categories/'.$cateinfo->id.'/edit')}}" class="btn btn-info">edit</a>
                  
                  <a href="{{url('/adminpanel2/categories/'.$cateinfo->id.'/delete')}}" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
                @endforeach
                </tbody>
