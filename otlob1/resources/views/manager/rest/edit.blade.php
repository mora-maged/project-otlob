...
{{$rest->name}} 
      ...
      <ol class="breadcrumb">
        ...
        <li ><a href="{{url('/adminpanel2/resturants')}}">resturants Control</a></li>
        <li class="active"><a href="{{url('/adminpanel2/resturants/'.$rest->id.'/edit')}}"> Edit resturant </a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            {!! Form::model($rest, ['method' => 'patch','url'=>['/adminpanel2/resturants',$rest->id],'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
