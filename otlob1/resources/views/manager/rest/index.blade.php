...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel2/resturants')}}">Resturants</a></li>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                 ...
                 <td>{{$restinfo->created_at}}</td>
                  <td>
                  <a href="{{url('/adminpanel2/resturants/'.$restinfo->id.'/edit')}}" class="btn btn-primary">edit</a>
                  
                  <a href="{{url('/adminpanel2/resturants/'.$restinfo->id.'/delete')}}" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
                @endforeach
                </tbody>
